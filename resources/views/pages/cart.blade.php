        ...
        <div class="container">
            <div class="row" data-aos="fade-up" data-aos-delay="100">
                <div class="col-12 table-responsive">
                    <table class="table table table-borderless table-cart">
                        <thead>
                            <tr>
                                <th>Image</th>
                                <th>Product Name</th>
                ...
                <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select type="text" class="form-control" id="provinces_id" name="provinces_id"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select type="text" class="form-control" id="regencies_id" name="regencies_id"
