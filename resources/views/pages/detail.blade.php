            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2" data-aos="zoom-in">
                        ...
                        @else
                        <a href="{{route('login')}}" class="btn btn-success px-4 text-white btn-block mb-3">Add to
                            Sign In</a>
                        @endauth
                        ...
                        <ul class="list-unstyled">
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">Nadia Steven</h5>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    Debitis quam ipsa enim repudiandae provident porro?
                                </div>
                            </li>
                            <li class="media">
                                <img src="/images/icons-testimonial-2.png" class="mr-3 rounded-circle" alt=""
                                    srcset="" />
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">Jhon Doe</h5>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    Debitis quam ipsa enim repudiandae provident porro?
                                </div>
                            </li>
                            <li class="media">
                                <img src="/images/icons-testimonial-3.png" class="mr-3 rounded-circle" alt=""
                                    srcset="" />
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">Lisa Caem</h5>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    Debitis quam ipsa enim repudiandae provident porro?
                                </div>
                            </li>
